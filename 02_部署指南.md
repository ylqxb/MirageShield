...
**硬件要求**：
- CPU：推荐 4 核（最低配置可降低，但可能影响性能）。若仅用于学习或轻量测试，2核也可运行，但可能影响性能。
- 内存：推荐 8GB（最低配置可降低，但可能影响性能）。若仅用于学习或轻量测试，4GB 也可运行，但可能影响性能。
- 存储：推荐 50GB 可用空间（最低配置可降低，但可能影响性能）。若仅用于学习或轻量测试，20GB 也可运行，但可能影响性能。
- 网络：稳定的网络连接
